                                    ...
                                    <Col className="material-body-top-borderR" span={8}>
                                        ...
                                        >
                                            {this.getFD('materialTexture', {
                                                ...
                                                rules: [{ message: '材料不能超过256字符', max: 256 }],
                                            })(
                                                <Input disabled={(detail.status == 1 || detail.status == 2) ? true : false} />
                                                )}
                                        </FormItem>
                                        ...
                                        >
                                            {this.getFD('brand', {
                                                ...
                                                rules: [{ message: '品牌不能超过256字符', max: 256 }],
                                            })(
                                                <Input disabled={(detail.status == 1 || detail.status == 2) ? true : false} />
                                                )}
                                        </FormItem>
                                    ...
                                    <Col className="material-body-top-borderR" span={8}>
                                        ...
                                        >
                                            {this.getFD('model', {
                                                ...
                                                rules: [{ message: '型号不能超过256字符', max: 256 }],
                                            })(
                                                <Input disabled={(detail.status == 1 || detail.status == 2) ? true : false} />
                                        ...
                                        >
                                            {this.getFD('materialCodeName', {
                                                ...
                                                rules: [{ message: '代号不能超过256字符', max: 256 }],
                                            })(
                                                <Input disabled={(detail.status == 1 || detail.status == 2) ? true : false} />
                                                )}
                                        </FormItem>
