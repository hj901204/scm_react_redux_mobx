...
import ImportViewComp from './ImportViewComp';
import ImportEmployeeAct from '../../actions/MaterialModule/MaterialAct';
import MaterialAct from '../../actions/MaterialModule/MaterialAct';
class ImportMaterialDialogComp extends Component{
...
export default connect(mapStateToProps,mapDispatchToProps)(ImportMaterialDialogComp);
