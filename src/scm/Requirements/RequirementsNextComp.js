...
class RequirementsComp extends FormModalComp {
    ...
    siteListSelect=(value)=>{
       ...
       requirementsNextStore.fetchComAddrBySiteList({addressCode:value.addressCode,siteCode:value.siteCode,status:1,page:1,pageSize:10})
    ...
    ComAddressSearch=(value)=>{
       requirementsNextStore.fetchComAddrBySiteList({siteCode:requirementsNextStore.siteCode,status:1,page:1,pageSize:10});
