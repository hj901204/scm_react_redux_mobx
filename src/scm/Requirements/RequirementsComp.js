        ...
        requirementsStore.redMessage=true;
         ...
         requirementsNextStore.fetchSiteList({siteCode:requirementsStore.siteCodeAttr[0],status:1,page:1,pageSize:10}).then(json=>{
            if(json.status===2000&&json.data.list){
                ...
                requirementsNextStore.fetchComAddrBySiteList({status:1,addressCode:requirementsNextStore.this_form.this_address?requirementsNextStore.this_form.this_address:json.data.list[0].addressCode,siteCode:requirementsStore.siteCodeAttr[0],page:1,pageSize:10}).then(json=>{
                    if(json.status===2000&&json.data.list){
