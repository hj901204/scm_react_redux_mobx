...
class AddProOrderComp extends FormComp {
    ...
    siteDataChange = (value) => {
        ...
        this.props.FreightSpace({ stockId: value });
    ...
    render() {
        ...
        let { getSiteData, getProOrgList, getDetailList, updateBom, Add_orderCode, type,treeData } = this.props;
        ...
        if (fsData) {
            fsData.map(key => {
                let getSpace = {};
                getSpace.catCode = key.locationCode;
                getSpace.catName = key.locationName;
        ...
        if(getDetailList.presetPosition){
            this.setState({spaceDisabled:true})
        }
                                            ...
                                            <Select disabled>
                                                {
                                                    spaceData.length > 0 ?
                                                        spaceData.map(spaceData => {
                                                            return <Select.Option value={spaceData.catCode} key={spaceData.catCode}>{spaceData.catCode+`[${spaceData.catName}]`}</Select.Option>
                                                        }) : null
                                                }
                                                </Select>
                                            )}
